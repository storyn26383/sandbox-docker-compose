...
- Base image is `phpswoole/swoole:6.0-php8.3` (Debian bookworm); don't suggest switching to Alpine — the alpine variant doesn't ship dev tooling and would need a lot of plumbing.
